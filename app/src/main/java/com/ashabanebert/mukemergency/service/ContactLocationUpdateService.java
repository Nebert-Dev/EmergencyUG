...
public class ContactLocationUpdateService extends Service
{
    ...
    private void getLocationFromServer(int u) {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            if(code == 200){
                                ...
                                ContactLocationUpdate contactLocationUpdate = gson.fromJson(gsonObject, ContactLocationUpdate.class);
                                EventBus.getDefault().post(contactLocationUpdate);
                            }
